  ...
  showChoosedPayment(isPaypalClicked,isCODClicked,isShopify)
   {
     ...
     else if(isCODClicked == true&&!isShopify)
     {
       return(
        <View>
          <Text style={css.layout.noItemsTextStyle}>{T.CODselected}</Text>
  ...
  showIndicator(){
    if(this.state.customStyles.colorsLoaded){
      return (<StepIndicator
               ...
               labels={[T.cart,T.delivery,T.payment,T.summary]}
               icons={['ios-cart-outline','ios-pin-outline','ios-card-outline','ios-list-box-outline']}
          />)
    }else{
      return (<View></View>)
    }
          ...
          >
            ...
            <View style={{flex:1}} tabLabel={T.delivery}>
             <View style={{flex:1}}>
                ...
                <FormLabel>{T.address_livraison}</FormLabel>
                <FormInput
            ...
            <View tabLabel={T.pay} style={{flex:1}}>
              <ConditionalDisplay condition={this.props.data.PayPalAvailable&&this.props.data.CODAvailable&&!this.props.data.isShopify}>
                <View style={css.static.paymentOptionsStyle}>
                  <ConditionalDisplay condition={this.props.data.PayPalAvailable&&this.props.data.CODAvailable}>
                      <PaymentOption
